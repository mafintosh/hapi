...
exports.send = function (request) {
    ...
    try {
        if (response.isBoom) {
            internals.fail(request, response);
            return;
        }

        internals.marshal(request);
        internals.transmit(response);
    }
    catch (err) {
...
internals.marshal = function (request) {
...
internals.fail = function (request, boom) {
